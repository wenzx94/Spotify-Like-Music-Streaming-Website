...
$query = "select * from user where username like '%$keywords%' or uname like '%$keywords%'";
$result = mysqli_query($link, $query) or die('Usr Query failed: ' . mysql_error());
?> 
...
<form action="../page-of/user.php" method = "POST">
<table>
    <tr>
    <th>  </th>
    <th>User Name</th>
...
?>
    ...
    <br></br>
    <input type = "submit"  name="user_select_button_2" value = "select">
    <br></br>
