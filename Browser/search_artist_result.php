...
$query = "select * from artist where aname like '%$keywords%' or adescr like '%$keywords%'";
...
<form action="../page-of/artist.php" method = "POST">
<table>
<tr>
<th>  </th>
<th>Name</th>
...
else 
{
    ...
    <br></br>
    <input type = "submit"  name="artist_select_button_2" value = "select">
    <br></br>
